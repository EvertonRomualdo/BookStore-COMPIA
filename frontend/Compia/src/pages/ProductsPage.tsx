import { useSearchParams } from "react-router-dom"; // responsavel por manter o estado da pagina no formato ex: /produtos?page=2 mesmo com f5
import Header from "../components/Header/Header"
import ProductCard from "../components/ProductCard/ProductCard"

function ProductsPage() {
    // o estado da pagina atual, para manter no formato de paginas e ser atualizado propriamente
    const [searchParams, setSearchParams] = useSearchParams();

    // se a url não tiver o ?page= começar da primeira pagina
    // interessante para não perder qual pagina estava ao dar um f5
    ...
    // base mockada por enquanto, discutir um pouco como vai ficar isso
    ...
    const books = [
        ...
        {
            id: 7,
            title: "A utilização de machine learning na identificação de elementos textuais geográficos",
    ...
    // a funcao que muda a url da pagina, por enquanto fica assim
